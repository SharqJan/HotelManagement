...
namespace SMSC.Admin.Controllers
{
    ...
    public class CheckInController : Controller
    {
        ...
        public CheckInController(ILog logger, IStringLocalizer<SharedResources> localizer, IMediator mediator)
        {
            _logger = logger;
        ...
        [HttpGet]
        public async Task<JsonResult> GetCheckReservationList(CancellationToken cancellationToken, ReservationDto reservationDto)
        {

            var getCheckReservationListQuery = new GetCheckReservationListQuery
            {
                ReservationDto = reservationDto
            };

            var resultReservationDto = await _mediator.Send(getCheckReservationListQuery, cancellationToken);
